...
[node-install-version]: {{ site.url }}/assets/node_install_version.PNG "node version"
[node-install]:{{ site.url }}/assets/node_install.PNG "nodejs install"
[tui-install]: {{ site.url }}/assets/tui-install.PNG "tui installed"
[tui-chart]: {{ site.url }}/assets/tui-chart.png "tui chart"